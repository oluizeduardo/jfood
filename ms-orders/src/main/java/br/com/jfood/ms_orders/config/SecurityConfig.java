...
public class SecurityConfig {
     ...
     * <ul>
     *     <li>Only users with the {@code MANAGER} role can list, register, update, or delete orders</li>
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers(HttpMethod.GET, "/orders/**").hasRole(ROLE_MANAGER)
                        .requestMatchers(HttpMethod.POST, "/orders").hasRole(ROLE_MANAGER)
                        .requestMatchers(HttpMethod.PUT, "/orders/**").hasRole(ROLE_MANAGER)
                        .requestMatchers(HttpMethod.DELETE, "/orders/**").hasRole(ROLE_MANAGER)
